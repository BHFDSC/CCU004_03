...
# MAGIC %md # CCU004_03-D02b-codelist_quality_assurance
# MAGIC
...
# MAGIC
# MAGIC **Data Output**
# MAGIC - **`ccu004_03_out_codelist_quality_assurance`** : The SNOMED/BNF codes that will be used for quality assurance checks in the later quality assurance notebook. This includes pregnancy/birth/HRT/COCP codes for male sex checks and prostate cancer codes for female sex checks.
